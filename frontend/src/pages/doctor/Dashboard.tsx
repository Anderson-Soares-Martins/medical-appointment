    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                <Card className="hover:shadow-lg transition-shadow cursor-pointer border-l-4 py-0 border-indigo-500 overflow-hidden">
                    <Button
                        variant="ghost"
                ...
                <Card className="hover:shadow-lg transition-shadow cursor-pointer border-l-4 py-0 border-green-500 overflow-hidden">
                    <Button
                        variant="ghost"
                        className="h-auto p-6 w-full justify-start"
                ...
                <Card className="hover:shadow-lg transition-shadow cursor-pointer border-l-4 py-0 border-purple-500 overflow-hidden">
                    <Button
                        variant="ghost"
                        className="h-auto p-6 w-full justify-start"
